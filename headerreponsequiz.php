...
<head>
    ...
    <meta content="http://www.taniapacheff.com" property="og:url">
    <meta content="http://url absolue de l'image" property="og:image"> <!-- image en 200x200px -->
    <meta content="Quiz nutritionnel de Tania Pacheff" property="og:title">;
    <meta content="Testez vos connaissances en diététique et débusquez les idées reçues !" property="og:description">
